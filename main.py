...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    output = tf.layers.conv2d_transpose(deconv2, num_classes,2, 8, padding='same')
    return  output
    ...
    for epoch in range(epochs):
        ...
        for images, gt_images in get_batches_fn(batch_size):
            ...
            feed = {input_image: images,
                    ...
                    keep_prob: 0.5,
                    learning_rate: 0.001}
            _, cr_loss = sess.run([train_op, cr_loss], feed_dict=feed)
...
def run():
    ...
    with tf.Session() as sess:
        ...
        image_input, keep_prob, layer3_out, layer4_out, layer7_out = load_vgg(vgg_path)
